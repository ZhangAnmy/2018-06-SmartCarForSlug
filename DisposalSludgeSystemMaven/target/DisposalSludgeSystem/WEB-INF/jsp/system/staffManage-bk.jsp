    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                </button> <img alt="140x140" src="img/user.png" width="10%" height="10%" />
                <h4 class="modal-title">新增用户</h4>
            </div>
            <div class="modal-body">
                <div class="container" style="width: 540px">
                    <form class="form-inline">
                        <div class="form-group"><label for="addRealName">姓&nbsp;&nbsp;&nbsp;&nbsp;名</label> <input type="text"
                                                                                                                   placeholder="请输入姓名" id="addRealName" class="form-control">
                        </div>
                        <div class="form-group"><label for="addLoginName">登录名：</label> <input type="text"
                                                                                              placeholder="请输入登录名" id="addLoginName" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="addLoginPass">密&nbsp;&nbsp;&nbsp;&nbsp;码</label> <input type="text"
                                                                                                                    placeholder="请重置密码" id="addLoginPass" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="addEmail">邮&nbsp;&nbsp;&nbsp;&nbsp;箱</label> <input type="text"
                                                                                                                placeholder="请输入邮箱" id="addEmail" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="addTel">电&nbsp;&nbsp;&nbsp;&nbsp;话</label> <input type="text"
                                                                                                              placeholder="请输入电话" id="addTel" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="addRole">角&nbsp;&nbsp;&nbsp;&nbsp;色</label>
								<span>
								<select id="addRole" name="statusId" size="1" style="height:29px; line-height:35px;">
                                    <option value="1">管理员</option>
                                    <option value="2" selected="selected">工作人员</option>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <div class="container" style="width: 540px">
                    <form class="form-inline">
                        <div class="form-group"><label for="editRealName">姓&nbsp;&nbsp;&nbsp;&nbsp;名</label> <input type="text"
                                                                                                                    placeholder="请输入姓名" id="editRealName" class="form-control">
                        </div>
                        <div class="form-group"><label for="editLoginName">登录名：</label> <input type="text"
                                                                                               placeholder="请输入登录名" id="editLoginName" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="editLoginPass">密&nbsp;&nbsp;&nbsp;&nbsp;码</label> <input type="text"
                                                                                                                     placeholder="请重置密码" id="editLoginPass" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="editEmail">邮&nbsp;&nbsp;&nbsp;&nbsp;箱</label> <input type="text"
                                                                                                                 placeholder="请输入邮箱" id="editEmail" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="editTel">电&nbsp;&nbsp;&nbsp;&nbsp;话</label> <input type="text"
                                                                                                               placeholder="请输入电话" id="editTel" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="editRole">角&nbsp;&nbsp;&nbsp;&nbsp;色</label> <input type="text"
                                                                                                                placeholder="请输入角色" id="editRole" class="form-control m-b control-label">
                        </div>
                        <div class="form-group"><label for="editStatus">状&nbsp;&nbsp;&nbsp;&nbsp;态</label> <input type="text"
                                                                                                                  placeholder="请选择状态" id="editStatus" class="form-control m-b control-label">
                        </div>
                    </form>
                </div>
            </div>
...
<div class="modal inmodal" id="checkModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <div class="container" style="width:540px">
                    <button id="checkUserSubmit1" type="button" class="btn btn-primary">通过</button>
                    <button id="checkUserSubmit2" type="button" class="btn btn-primary">不通过</button>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>
...
<div class="search-content">
    ...
    <div class="query-site-btn">
        <div class="form-inline">
            <div>
					<span>
						<select id="userStatus" name="statusId" size="1" style="height:29px; line-height:35px;">
                            <option>-请选择状态-</option>
                ...
                <input type="text" class="form-control" placeholder="请输入用户姓名或登录名" id="queryInput">
