...
.back {
							...
							<div class="col-lg-offset-2">
								<div class="form-inline">
									...
									<div class="form-group col-lg-offset-1" id="siteList" style="margin-top:4px;">
										<label class="sr-only">厂家</label>
										<div class="input-group">
											<div class="btn-group">
												<button class="btn btn-default" disabled="disabled">选择厂家</button>
	...
	<script type="text/javascript">
		...
		var siteName = "湖南星科环保科技有限公司";
//		$(function(){
			$.ajax( {
				type : "POST",
				url : "analyse/querySludgeBySiteName?siteName=" + siteName,
//				url : "analyse/querySludgeBySiteName?siteName=湖南星科环保科技有限公司",
				dataType : "json",
...
//		});
		...
		$("#submit").click(function() {
			...
			$.ajax({
				type : "POST",
				url : "analyse/querySludgeByDates?startDate=" + startDate + "&endDate=" + endDate,
				dataType : "json",
				contentType : "application/json",
				success : function(sludgeList) {
					var length = sludgeList.size();
